...
public class QuotationMoneyDto implements Dto {
	 ...
	 */
	public QuotationMoneyDto(DivisaDto money, Money amount, String numberAccount, String typeBusiness,
			String divisaTasUSD, String divisaTasPes, String divisaTasPesUSD, String equivalentPeso) {
		this.money = money;
		this.amount = amount;
	...
	public int hashCode() {
		return new HashCodeBuilder().append(getAmount()).append(getDivisaTasPes()).append(getDivisaTasPesUSD())
				.append(getDivisaTasUSD()).append(getEquivalentPeso()).append(getMoney()).append(getNumberAccount())
				.append(getTypeBusiness()).toHashCode();
	}

	@Override
	public boolean equals(Object obj) {
		return (obj != null) && (obj instanceof QuotationMoneyDto)
				...
				&& (this.getTypeBusiness() != null && ((QuotationMoneyDto)obj).getTypeBusiness() != null);
	...
	public String toString() {
		return new ToStringBuilder(this).append("Amount", getAmount()).append("divisaTasaPeso", getDivisaTasPes())
				...
				.append("numeroCuenta", getNumberAccount()).append("tipodeOperacion", getTypeBusiness()).toString();
	}
	...
	/**
	 * @param typeBusiness the typeBusiness to set
	 */
