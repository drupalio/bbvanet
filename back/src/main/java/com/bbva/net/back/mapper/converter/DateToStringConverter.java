...
/**
 * DateToStringConverter provides custom conversion from String values to and from Date instances, based on a provided date
 * format pattern.<br>
 * <br>
 * The format is applied based on the rules defined in {@link java.text.SimpleDateFormat}.
 */
public class DateToStringConverter extends CustomConverter<String, Date> {
	...
	/**
	 * Constructs a new instance of DateToStringConverter capable of parsing and constructing Date strings according to the
	 * provided format.
	 * 
	 * @param format the format descriptor, processed according to the rules defined in {@link java.text.SimpleDateFormat}
	 */
