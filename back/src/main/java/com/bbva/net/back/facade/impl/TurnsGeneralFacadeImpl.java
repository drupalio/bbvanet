...
public class TurnsGeneralFacadeImpl extends AbstractBbvaFacade implements TurnsGeneralFacade {
    ...
    @Override
    public List<turnsClientDetailDto> getTurns(final String advanceNumber, final DateRangeDto dateRange, final String type,
            final Integer paginationKey, final Integer pageSize, final String clientId) {
        this.turnsClient = new ArrayList<turnsClientDetailDto>();

        FormCurrencyDto form = new FormCurrencyDto("4", "1", "");
        QuotationMoneyDto quotation = new QuotationMoneyDto(new DivisaDto("EUR", "3"), new Money(new BigDecimal(5000)), "0013-0411-00-398000030",
                "NM", "3,655.00", "3,655.00", "3,655.00", "3,655.00");
        QuotationMoneyDto quotation1 = new QuotationMoneyDto(new DivisaDto("USD", "2"), new Money(new BigDecimal(700000)), "0013-0411-00-776456483",
                "MN", "3,655.00", "3,655.00", "3,655.00", "3,655.00");
        ...
        turnsClientDetailDto turns0 = new turnsClientDetailDto(new Date(), "T00283", new Date(), "STD", "Transferencia personal",
                "SETECIENTOS SESENTA MIL", "34252435", contact, contact1, bank1, form, quotation, "");

        turnsClientDetailDto turns1 = new turnsClientDetailDto(new Date(), "H00555", new Date(), "STD", "Transferencia",
                "SETECIENTOS SESENTA MIL", "34252435", contact, contact1, bank2, form, quotation1, "");
