...
public class TurnsClientDetailDto implements Dto {
	 ...
	 * @param rates
	 */
	public TurnsClientDetailDto(Date operationDate, String operationNumber, Date operationHour, String referenceOper,
			String transferDescription, String amountLetter, String advanceNumber, ContactDto beneficiary,
			ContactDto ordenant, BankDto bankIntermediary, FormCurrencyDto formCurrency, QuotationMoneyDto rates,
	...
	public int hashCode() {
		return new HashCodeBuilder().append(getOperationDate()).append(getOperationNumber()).append(getOperationHour())
				.append(getReferenceOper()).append(getTransferDescription()).append(getAmountLetter())
				.append(getAdvanceNumber()).append(getBeneficiary()).append(getOrdenant())
				.append(getBankIntermediary()).append(getFormCurrency()).append(getRates()).append(getStateOperation())
				.toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("fecha operacion", getOperationDate())
				.append("cod operacion", getOperationNumber()).append("tasas", getStateOperation())
				.append("referencia", getReferenceOper()).append("hora operacion", getOperationHour())
				.append("valor letras", getAmountLetter()).append("descripcion", getTransferDescription())
				.append("beneficiario", getBeneficiary()).append("avance", getAdvanceNumber())
				.append("banco intermediario", getBankIntermediary()).append("ordenate", getOrdenant())
