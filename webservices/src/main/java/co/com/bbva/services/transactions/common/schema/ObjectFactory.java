 ...
 * generated in the co.com.bbva.services.transactions.common.schema package. 
...
public class ObjectFactory {
    ...
    private final static QName _GeneralErrorResponseType_QNAME = new QName("http://www.bbva.com.co/services/transactions/common/schema", "generalErrorResponseType");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: co.com.bbva.services.transactions.common.schema
     * 
     */
    ...
    public JAXBElement<GeneralErrorResponseType> createGeneralErrorResponseType(GeneralErrorResponseType value) {
        return new JAXBElement<GeneralErrorResponseType>(_GeneralErrorResponseType_QNAME, GeneralErrorResponseType.class, null, value);
    }
