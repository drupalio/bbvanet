...
/**
 * <p>
 * Clase Java para adaptedIDestinationAdapter complex type.
 * <p>
...
@XmlType(name = "adaptedIDestinationAdapter", propOrder = { "cardNumber", "ccc", "clabe", "creditNumber",
		"mobilePhoneNumber" })
public class AdaptedIDestinationAdapter implements Serializable {

	private static final long serialVersionUID = -7836445632464221770L;
