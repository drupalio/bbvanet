...
/**
 * <p>
 * Clase Java para AuthenticationState complex type.
 * <p>
...
@XmlType(name = "AuthenticationState", propOrder = { "authenticationState", "authenticationData", "userType",
		"userStatus", "clientStatus", "countableTerminal" })
public class AuthenticationState implements Serializable {

	private static final long serialVersionUID = 3009636235934251627L;
