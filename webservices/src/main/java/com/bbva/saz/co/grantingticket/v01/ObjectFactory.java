 ...
 * generated in the com.bbva.saz.co.grantingticket.v01 package. 
...
public class ObjectFactory {
    ...
    private final static QName _UserPreferences_QNAME = new QName("http://bbva.com/saz/co/grantingticket/V01", "UserPreferences");
    private final static QName _AuthenticationState_QNAME = new QName("http://bbva.com/saz/co/grantingticket/V01", "AuthenticationState");
    private final static QName _Authentication_QNAME = new QName("http://bbva.com/saz/co/grantingticket/V01", "Authentication");
    private final static QName _AuthenticationData_QNAME = new QName("http://bbva.com/saz/co/grantingticket/V01", "AuthenticationData");
    private final static QName _ConsumerContext_QNAME = new QName("http://bbva.com/saz/co/grantingticket/V01", "ConsumerContext");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.bbva.saz.co.grantingticket.v01
     * 
     */
