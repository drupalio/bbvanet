 ...
 * element interface generated in the com.bbva.czic.dto.net package.
 * <p>
...
public class ObjectFactory {
	 ...
	 * schema derived classes for package: com.bbva.czic.dto.net
	 * 
	 */
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link Activity }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<Activity> createActivity(Activity value) {
		return new JAXBElement<Activity>(_Activity_QNAME, Activity.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link EnumRotaryMoveStatus }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "urn:com:bbva:czic:dto:net", name = "EnumRotaryMoveStatus")
	public JAXBElement<EnumRotaryMoveStatus> createEnumRotaryMoveStatus(
			EnumRotaryMoveStatus value) {
		return new JAXBElement<EnumRotaryMoveStatus>(
				_EnumRotaryMoveStatus_QNAME, EnumRotaryMoveStatus.class, null,
				value);
	}
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link ContactInfo }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<ContactInfo> createContactInfo(ContactInfo value) {
		return new JAXBElement<ContactInfo>(_ContactInfo_QNAME,
				ContactInfo.class, null, value);
	}
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link EnumAccountState }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "urn:com:bbva:czic:dto:net", name = "EnumAccountState")
	public JAXBElement<EnumAccountState> createEnumAccountState(
			EnumAccountState value) {
		return new JAXBElement<EnumAccountState>(_EnumAccountState_QNAME,
				EnumAccountState.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link EnumFinancialStatusType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "urn:com:bbva:czic:dto:net", name = "EnumFinancialStatusType")
	public JAXBElement<EnumFinancialStatusType> createEnumFinancialStatusType(
			EnumFinancialStatusType value) {
		return new JAXBElement<EnumFinancialStatusType>(
				_EnumFinancialStatusType_QNAME, EnumFinancialStatusType.class,
				null, value);
	}
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link Function }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<Function> createFunction(Function value) {
		return new JAXBElement<Function>(_Function_QNAME, Function.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link Location }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<Location> createLocation(Location value) {
		return new JAXBElement<Location>(_Location_QNAME, Location.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link PhoneNumber }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<PhoneNumber> createPhoneNumber(PhoneNumber value) {
		return new JAXBElement<PhoneNumber>(_PhoneNumber_QNAME,
				PhoneNumber.class, null, value);
	}
	...
	public JAXBElement<Country> createCountry(Country value) {
		return new JAXBElement<Country>(_Country_QNAME, Country.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <} {@link Contract }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<Contract> createContract(Contract value) {
		return new JAXBElement<Contract>(_Contract_QNAME, Contract.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link Movement }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<Movement> createMovement(Movement value) {
		return new JAXBElement<Movement>(_Movement_QNAME, Movement.class, null,
				value);
	}
	...
	public JAXBElement<Balance> createBalance(Balance value) {
		return new JAXBElement<Balance>(_Balance_QNAME, Balance.class, null,
				value);
	}
	...
	public JAXBElement<Conditions> createConditions(Conditions value) {
		return new JAXBElement<Conditions>(_Conditions_QNAME, Conditions.class,
				null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link EnumLoanStatus }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<EnumLoanStatus> createEnumLoanStatus(EnumLoanStatus value) {
		return new JAXBElement<EnumLoanStatus>(_EnumLoanStatus_QNAME,
				EnumLoanStatus.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link EnumPhoneNumberType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "urn:com:bbva:czic:dto:net", name = "EnumPhoneNumberType")
	public JAXBElement<EnumPhoneNumberType> createEnumPhoneNumberType(
			EnumPhoneNumberType value) {
		return new JAXBElement<EnumPhoneNumberType>(_EnumPhoneNumberType_QNAME,
				EnumPhoneNumberType.class, null, value);
	}
	...
	public JAXBElement<Operation> createOperation(Operation value) {
		return new JAXBElement<Operation>(_Operation_QNAME, Operation.class,
				null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link EnumProductType }
	 * {@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "urn:com:bbva:czic:dto:net", name = "EnumProductType")
	public JAXBElement<EnumProductType> createEnumProductType(
			EnumProductType value) {
		return new JAXBElement<EnumProductType>(_EnumProductType_QNAME,
				EnumProductType.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link EnumContactSourceType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "urn:com:bbva:czic:dto:net", name = "EnumContactSourceType")
	public JAXBElement<EnumContactSourceType> createEnumContactSourceType(
			EnumContactSourceType value) {
		return new JAXBElement<EnumContactSourceType>(
				_EnumContactSourceType_QNAME, EnumContactSourceType.class,
				null, value);
	}
	...
	public JAXBElement<Payment> createPayment(Payment value) {
		return new JAXBElement<Payment>(_Payment_QNAME, Payment.class, null,
				value);
	}
	...
	public JAXBElement<Balance> createLoanBalance(Balance value) {
		return new JAXBElement<Balance>(_LoanBalance_QNAME, Balance.class,
				Loan.class, value);
	}
	...
	public JAXBElement<Payment> createLoanPayment(Payment value) {
		return new JAXBElement<Payment>(_LoanPayment_QNAME, Payment.class,
				Loan.class, value);
	}
	...
	public JAXBElement<EnumLoanStatus> createLoanStatus(EnumLoanStatus value) {
		return new JAXBElement<EnumLoanStatus>(_LoanStatus_QNAME,
				EnumLoanStatus.class, Loan.class, value);
	}
	...
	public JAXBElement<Balance> createLoanDebt(Balance value) {
		return new JAXBElement<Balance>(_LoanDebt_QNAME, Balance.class,
				Loan.class, value);
	}
