...
public class ObjectFactory {
	...
	private final static QName _EnumRotaryMoveStatus_QNAME = new QName("urn:com:bbva:czic:dto:net",
	...
	private final static QName _EnumFinancialStatusType_QNAME = new QName("urn:com:bbva:czic:dto:net",
	...
	public JAXBElement<EnumRotaryMoveStatus> createEnumRotaryMoveStatus(EnumRotaryMoveStatus value) {
		return new JAXBElement<EnumRotaryMoveStatus>(_EnumRotaryMoveStatus_QNAME, EnumRotaryMoveStatus.class, null,
				value);
	}
	...
	public JAXBElement<EnumFinancialStatusType> createEnumFinancialStatusType(EnumFinancialStatusType value) {
		return new JAXBElement<EnumFinancialStatusType>(_EnumFinancialStatusType_QNAME, EnumFinancialStatusType.class,
				null, value);
	}
