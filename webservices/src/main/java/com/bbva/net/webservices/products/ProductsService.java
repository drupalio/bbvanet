...
public interface ProductsService {
    ...
    List<Movement> listMovements(@PathParam("productId") String productId, @QueryParam("$filter") @DefaultValue("null") String $filter, @QueryParam("paginationKey") @DefaultValue("null") Integer paginationKey, @QueryParam("pageSize") @DefaultValue("null") Integer pageSize);

    @GET
    @Produces("application/json")
    @Path("/{productId}/movements/{movementId}")
    Movement getMovement(@PathParam("productId") String productId, @PathParam("movementId") String movementId, @QueryParam("$filter") @DefaultValue("null") String $filter);
