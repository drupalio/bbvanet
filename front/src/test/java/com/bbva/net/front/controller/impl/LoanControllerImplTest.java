...
public class LoanControllerImplTest extends AbstractBbvaControllerTest {
    ...
    public void init() {
        ...
        this.loanController.setGlobalPositionFacade(globalPositionFacade);
    ...
    public void checkProductSelect() {
        ...
        Mockito.when(this.globalPositionFacade.getGlobalProductsByUser()).thenReturn(new GlobalProductsDto());
        // init
        this.loanController.init();
        
        // catch
        Mockito.when(this.globalPositionFacade.getGlobalProductsByUser()).thenThrow((new RestClientException("OK")));
        // init
        this.loanController.init();
    }
}
