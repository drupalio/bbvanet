...
$(document).ready(function() {
	...
	$(document).delegate('.ui-selectonemenu', 'keyup', function(event) {
		if ($(this).hasClass('open')) {
			...
			if (event.keyCode === 13) {
				$('.ui-selectonemenu').addClass('open');
				$('.ui-selectonemenu').children('.ui-selectonemenu-label').addClass('open');
				$('.ui-selectonemenu').children('.ui-selectonemenu-trigger').addClass('open');
			}
		}
	});
