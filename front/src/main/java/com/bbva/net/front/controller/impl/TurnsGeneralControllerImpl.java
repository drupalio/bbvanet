 ...
 * @author Entelgy
 */
public class TurnsGeneralControllerImpl extends PaginationController<turnsClientDetailDto> implements TurnsGeneralController {
    ...
    protected List<turnsClientDetailDto> getNextPage(int paginantionKey, int psize) {
        try {
            return this.turnsGeneralFacade.getTurns(getAdvanceNumber(), getDateRange(), getType(), paginantionKey, psize, getClientId());
        } catch (Exception e) {
