...
public class TurnsOperationControllerImpl extends AbstractBbvaController implements TurnsOperationController {
    ...
    public void appendOudSide() {
        ...
        getRenderComponents().put(RenderAttributes.FOOTEROUTSIDE.name(), true);
        // Initial
    ...
    public void appendInSide() {
        ...
        getRenderComponents().put(RenderAttributes.FOOTERRECIVED.name(), true);
        // Outside
    ...
    public void appendDivisaIni() {
        ...
        getRenderComponents().put(RenderAttributes.FOOTERDIVISAINI.name(), true);
    }
